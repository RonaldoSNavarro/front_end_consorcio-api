...
description: >
  ...
  implementar qualquer aspect de consórcio: regras de sorteio/contemplação por Loteria Federal,
...
- **Não comercializada:** Vaga ainda não vendida; não participa de nenhum sorteio
...
O valor do crédito é reajustado periodicamente.
