...
- Name: compliance.spec.js >> Compliance e Testes Negativos >> Deve bloquear lance de cota CANCELADA na Assembleia
- Location: e2e\compliance.spec.js:33:3
...
Call log:
  - waiting for locator('text=Lances Pendentes')
